...
namespace Radarr.Api.V3.Queue
{
                               ...
                               IHandle<QueueUpdatedEvent>, IHandle<PendingReleasesUpdatedEvent>
    {
        ...
        [RestDeleteById]
        public void RemoveAction(int id, bool removeFromClient = true, bool blacklist = false)
        {
        ...
        [HttpDelete("bulk")]
        public object RemoveMany([FromBody] QueueBulkResource resource, [FromQuery] bool removeFromClient = true, [FromQuery] bool blacklist = false)
        {
